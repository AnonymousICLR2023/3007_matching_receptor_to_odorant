...
from Rec2Odorant.main.CLS_GNN_MHA.model.essentials.BasicMPNN import BasicTruncatedNormalDynamicMessagePassing
from Rec2Odorant.main.CLS_GNN_MHA.model.essentials.embeddings import *


class Identity(flax.linen.Module):
    @flax.linen.compact
    def __call__(self, inputs, deterministic, rng = None):
        G = inputs
        return G

class noGNN_QK_model(flax.linen.Module):
    """
    NOTE: This is Transformer
    """
    ...
    def setup(self):
        ...
        # ----------- 0:
        self.mha_mpnn_Q = Identity()
        self.mha_mpnn_K = Identity()
        # self.mha_mpnn_V = Identity()
        ...
        # ----------- 1:
        self.mha_mpnn_Q_1 = Identity()
        self.mha_mpnn_K_1 = Identity()
        # self.mha_mpnn_V_1 = Identity()
        ...
        # ----------- 2:
        self.mha_mpnn_Q_2 = Identity()
        self.mha_mpnn_K_2 = Identity()
        # self.mha_mpnn_V_2 = Identity()
        ...
        # ----------- 3:
        self.mha_mpnn_Q_3 = Identity()
        self.mha_mpnn_K_3 = Identity()
        # self.mha_mpnn_V_3 = Identity()
        ...
        # ----------- 4:
        self.mha_mpnn_Q_4 = Identity()
        self.mha_mpnn_K_4 = Identity()
        # self.mha_mpnn_V_4 = Identity()
