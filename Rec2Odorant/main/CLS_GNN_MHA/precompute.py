...
from Rec2Odorant.mol2graph.read import read_fasta

from Rec2Odorant.main.utils import serialize_BERT_hidden_states
...
if __name__ == '__main__':
    ...
    precomuteBERT_CLS = PrecomputeProtBERT_CLS(data_file = os.path.join('Rec2Odorant','main', 'CLS_GNN_MHA', 'Data','chemosimdb','mixDiscard_20220929-184244','seqs.csv'), # seqs.csv
                                        save_dir = os.path.join('Rec2Odorant','main', 'CLS_GNN_MHA', 'Data','chemosimdb','mixDiscard_20220929-184244'),
                                        mode = 'w',
