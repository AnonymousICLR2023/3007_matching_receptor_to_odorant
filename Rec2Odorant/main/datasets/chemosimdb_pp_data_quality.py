...
class CVPP_addWeights_DataQuality(BaseCVPostProcess):
    ...
    def __init__(self, data_dir, auxiliary_data_path):
        name = 'quality__screening_weight' # 'quality__LogHarmonic' + '_' + 'screening' + '_' + 'class'
    ...
    def _postprocess(self, data, auxilary):
        ...
        # data['sample_weight'] = data['weighted_LogHarmonic_weight'] * data['screening_weight'] * data['class_weight']
        return data
...
if __name__ == '__main__':
    ...
    discard_primary = CVPP_Discard_Primary(data_dir = data_dir)
