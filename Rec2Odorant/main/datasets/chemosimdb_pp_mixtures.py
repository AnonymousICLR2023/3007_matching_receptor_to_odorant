...
from Rec2Odorant.main.database_utils import get_map_inchikey_to_isomericSMILES, get_map_inchikey_to_canonicalSMILES, enumerate_isomers, merge_cols_with_priority, pubchem_isoSMILES_to_RDKit_isoSMILES
...
if __name__ == '__main__':
    ...
    data_dir = 'BERT_GNN/Data/chemosimdb/mixDiscard_20220608-144844/EC50_random_data/20220608-145000/orphans__keep/quality__screening_weight'

    test = CVPP_Mixture_Chiral_Only(data_dir = data_dir, 
