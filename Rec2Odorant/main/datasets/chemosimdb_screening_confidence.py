...
from Rec2Odorant.main.database_utils import perform_mutation, merge_cols_with_priority
...
class ScreeningConfidence:
    ...
    def main(self):
        ...
        # print('\nWARNING: Check TODOs when Maxence uploads new version.\n')
        # pairs_ec50 = pairs_ec50[~((pairs_ec50 > 0.0)&(pairs_ec50 < 1.0))].astype(int) # TODO: Delete when Maxence sends updated version! ! 
...
if __name__ == '__main__':
    screening_confidence = ScreeningConfidence(base_working_dir = os.path.join('BERT_GNN', 'Data', 'chemosimdb'), # os.path.join('datasets', 'chemosimdb_confidence', 'tmp'),
                                        data_path = {'pairs': '/home/matej/Documents/repos/MatejHl/ChemosimDB/ChemosimDB/Data/Exports/export_20220512-135815.csv', # export_20220512-135815
