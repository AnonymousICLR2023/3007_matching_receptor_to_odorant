...
from Rec2Odorant.main.datasets.db_screening_confidence import *
from Rec2Odorant.main.datasets.db_cv import *
from Rec2Odorant.main.datasets.db_split import *
from Rec2Odorant.main.datasets.db_pp import *
from Rec2Odorant.main.datasets.db_pp_mixtures import *
from Rec2Odorant.main.datasets.db_pp_data_quality import *
from Rec2Odorant.main.datasets.db_pp_orphans import *
from Rec2Odorant.main.datasets.db_pp_discard_test import *
...
def deorphanization_split(working_dir, case, seq_similarity_dir):
    """
    """
    if case == 'OR_random':
        i = 1
            ...
            try:
                ec50_leaveClusterOut_OR = EC50_LeaveClusterOut_OR(data_dir = working_dir,
                                                    ...
                                                    split_kwargs = {'valid_ratio' : 0.8, # Number of measurements in validation set: valid_ratio*n_ec50
                                                                ...
                                                                'auxiliary_data_path' : {'seq_dist' : os.path.join(seq_similarity_dir, 'sim_dist_matrix.csv'),
                                                                                        'seq_dist_ids' : os.path.join(seq_similarity_dir, 'seqs.csv'),
                                                                                        }})
...
# -------------------------------------------
def main_postprocess_IV_to_VII(pairs_working_dir, seq_similarity_dir):
    """
    """
    ...
    # ----- OR random:
    split_working_dir = deorphanization_split(pairs_working_dir, case = 'OR_random', seq_similarity_dir = seq_similarity_dir)
    #  Discard Neg:
    ...
    # ----- OR cluster:
    split_working_dir = deorphanization_split(pairs_working_dir, case = 'OR_cluster', seq_similarity_dir = seq_similarity_dir)
    #  Discard Neg:
    _working_dir = discrad_occuring_in_test(split_working_dir, case = 'OR_DiscardNeg')
    _orphans__keep_quality__weight_mix__concat(_working_dir)
    del _working_dir
    ...
    del split_working_dir
    # ----- Mol random:
    split_working_dir = deorphanization_split(pairs_working_dir, case = 'Mol_random', seq_similarity_dir = seq_similarity_dir)
    #  Discard Neg:
    _working_dir = discrad_occuring_in_test(split_working_dir, case = 'Mol_DiscardNeg')
    _orphans__keep_quality__weight_mix__concat(_working_dir)
    del _working_dir, split_working_dir
    # ----- Mol cluster:
    split_working_dir = deorphanization_split(pairs_working_dir, case = 'Mol_cluster', seq_similarity_dir = seq_similarity_dir)
    #  Discard Neg:
    _working_dir = discrad_occuring_in_test(split_working_dir, case = 'Mol_DiscardNeg')
    _orphans__keep_quality__weight_mix__concat(_working_dir)
    del _working_dir, split_working_dir
...
if __name__ == '__main__':
    ...
    if run_screening_confidence: # /mnt/Rec2Odorant/
        screening_confidence = ScreeningConfidence(base_working_dir = '/mnt/Rec2Odorant/main/CLS_GNN_MHA/Data/db',
                                            data_path = {'pairs': '/mnt/Rec2Odorant/Dataset/export_20220512-135815.csv',
                                                        'uniprot_sequences': '/mnt/Rec2Odorant/Dataset/uniprot_sequences.csv',
                                                        })
    ...
    if run_preprocess: # /mnt/Rec2Odorant/
        ORpairs = CV_ORpairs_DiscardMix(base_working_dir = '/mnt/Rec2Odorant/main/CLS_GNN_MHA/Data/db',
                                    data_path = {'pairs': '/mnt/Rec2Odorant/Dataset/export_20220512-135815.csv',
                                                'uniprot_sequences': '/mnt/Rec2Odorant/Dataset/uniprot_sequences.csv',
    ...
    if True:
        main_postprocess_IV_to_VII(ORpairs_dir, seq_similarity_dir = '/mnt/Rec2Odorant/Dataset/_seq_dist_matrices')
        main_postprocess_IV_to_VII(ORpairs_dir, seq_similarity_dir = '/mnt/Rec2Odorant/Dataset/_seq_dist_matrices')
        main_postprocess_IV_to_VII(ORpairs_dir, seq_similarity_dir = '/mnt/Rec2Odorant/Dataset/_seq_dist_matrices')
        main_postprocess_IV_to_VII(ORpairs_dir, seq_similarity_dir = '/mnt/Rec2Odorant/Dataset/_seq_dist_matrices')
        main_postprocess_IV_to_VII(ORpairs_dir, seq_similarity_dir = '/mnt/Rec2Odorant/Dataset/_seq_dist_matrices')
    ...
    # ---------------------
    if True:
        ORpairs = CV_ORpairs_OnlyMix(base_working_dir = '/mnt/Rec2Odorant/main/CLS_GNN_MHA/Data/db',
                                    data_path = {'pairs': '/mnt/Rec2Odorant/Dataset/export_20220512-135815.csv',
                                                'uniprot_sequences': '/mnt/Rec2Odorant/Dataset/uniprot_sequences.csv',
                                                'map_inchikey_to_isomericSMILES' : None,
                                                'map_inchikey_to_canonicalSMILES' : None,
