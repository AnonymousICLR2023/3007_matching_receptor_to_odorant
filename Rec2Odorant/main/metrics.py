...
# NOTE: DELETE THIS
# def roc_auc_OLD(cm_per_threshold, max_fpr=None):
#     """
#     https://github.com/scikit-learn/scikit-learn/blob/7e1e6d09bcc2eaeba98f7e737aac2ac782f0e5f1/sklearn/metrics/_ranking.py#L47
#     """
#     vals = np.array([roc_per_threshold(cm_per_threshold[key]) for key in cm_per_threshold.keys()])
#     fpr=vals[:, 0]
#     tpr=vals[:, 1]
# 
...
# NOTE: DELETE THIS
# def plot_roc_curve_OLD(cm_per_threshold):
#     """
#     Returns a matplotlib figure containing the plotted ROC curve.
#     
#     Paramters:
#     ----------
#     cm_per_threshold : dict
#         dictionary of conffusion matrix per threshold. {threshold : cm}
#     """
#     vals = np.array([roc_per_threshold(cm_per_threshold[key]) for key in cm_per_threshold.keys()])
# 
#     viz = RocCurveDisplay(fpr=vals[:, 0], tpr=vals[:, 1], roc_auc=None, estimator_name=None, pos_label=None)
#     return viz.plot().figure_
...
# NOTE: DELETE THIS
# def log_roc_curve_OLD(cm_per_threshold):
#     figure = plot_roc_curve_OLD(cm_per_threshold)
#     image, shape = plot_to_png(figure)
#     return Image(shape, image)