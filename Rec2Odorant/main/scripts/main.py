...
if __name__ == '__main__':
    ...
    if params['CASE'] == 'BERT_GNN':
        if params['ACTION'] == 'train':
            from Rec2Odorant.main.CLS_GNN_MHA.main_train import main_train
            output = main_train(params)
        elif params['ACTION'] == 'eval':
            from Rec2Odorant.main.CLS_GNN_MHA.main_eval import main_eval
            output = main_eval(params)
        elif params['ACTION'] == 'predict':
            from Rec2Odorant.main.CLS_GNN_MHA.main_predict import main_predict
            output = main_predict(params)
        elif params['ACTION'] == 'predict_single':
            from Rec2Odorant.main.CLS_GNN_MHA.main_predict_single import main_predict_single
