...
from Rec2Odorant.odor_description.metrics import log_confusion_matrix
...
from Rec2Odorant.odor_description.utils import _serialize_hparam
...
from Rec2Odorant.odor_description.multiLabel.GNN.MPNN.make_train_and_eval import make_train_epoch, make_valid_epoch
from Rec2Odorant.odor_description.multiLabel.GNN.MPNN.make_regularization_loss import make_regularization_loss

import logging

os.environ['CUDA_VISIBLE_DEVICES'] = "0"
# _datacase = os.path.join('pyrfume_base_20220908-114642','random_data','20220908-115036')
...
def main_train(hparams):
    ...
    #             'RESTORE_FILE' : None,
    #             'N_PARTITIONS' : 0,
    #             'OPTIMIZATION' : {'OPTION' : 'adamw_polynomial'}
    #             }
    ...
    # restore_file = os.path.join(logdir, 'VanillaMPNN', '20220614-180240', 'ckpts', 'state_e400.pkl')
    ...
    if hparams['LOADER_OUTPUT_TYPE'] == 'jax':
        ...
        loader = _loader.tf_Dataset(output_signature = get_tf_specs(is_weighted = True, n_node_features = len(hparams['ATOM_FEATURES']), 
        ...
        valid_loader = _valid_loader.tf_Dataset(output_signature = get_tf_specs(is_weighted = False, n_node_features = len(hparams['ATOM_FEATURES']), 
                            n_edge_feature = len(hparams['BOND_FEATURES']), node_padding = hparams['PADDING_N_NODE'], edge_padding = hparams['PADDING_N_EDGE'], 
                            n_classes = hparams['NUM_CLASSES']))
