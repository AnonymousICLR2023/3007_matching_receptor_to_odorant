...
#from Custom_Flax_code.layers.gnn import ECCLayer, GlobalAttnSumPoolLayer

from Rec2Odorant.odor_description.multiLabel.GNN.MPNN.model.essentials import *
...
class VanillaMPNN(flax.linen.Module):
    ...
    def setup(self):
        ...
        # self.dense_2 = flax.linen.Dense(128)
        ...
        self.mpnn = MPNN(num_propagation_steps = 5, edge_embedding_size=self.edge_embedding_size, message_activation=self.mpnn_message_activation)
