...
from Rec2Odorant.odor_description.base_cross_validation import BaseCVPreProcess
...
class Pyrfume_PreProcess(BaseCVPreProcess):
    ...
    def func_data(self, raw_data):
        ...
        def compute_smiles(cids_list):
            ...
            return _smiles # list(itertools.chain(*_smiles))
...
if __name__ == '__main__':
    ...
    pyrfume_base = Pyrfume_PreProcess(base_working_dir = os.path.join('JAX','multiLabel', 'GNN', 'Data', 'Pyrfume_dataset'), data_path=None)
    pyrfume_base.CV_data()
    print('func_data:     {}'.format(pyrfume_base.hparams['func_data']))
